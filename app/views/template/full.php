...
<body class="theme-full <?php echo $this->body_class; ?>">

<div class="container site-wrapper">

    <div class="row row-header">

	    <div class="col-xs-12 col-sm-9 col-md-8 col-sm-push-3 col-md-push-4 main">
        ...
        <div class="col-xs-12 col-sm-3 col-md-4 col-sm-pull-9 col-md-pull-8 sidebar">

            <div class="logo">
                <a href="<?php echo site_url() ?>" title="página inicial">
                    <img src="<?php echo img() ?>simbolo-vcongresso.png" alt=""/></a>
            </div>
