    ...
    <div class="form-group <?php err('tipo_usuario') ?>">
        ...
        <div class="col-sm-8">
            ...
            <select name="tipo_usuario" id="field_tipo_usuario" class="form-control">
                <option value="">Escolha...</option>
                <option value="profissional" <?php echo set_select('tipo_usuario', 'profissional'); ?>>Profissional
                </option>
    ...
    <div class="form-group <?php err('forma_pagamento') ?>">
        ...
        <div class="col-sm-8">
            ...
            <select name="forma_pagamento" id="field_forma_pagamento" class="form-control">
                ...
                <?php if($parcelas):?>
                <option value="parcelado" <?php echo set_select('forma_pagamento', 'parcelado'); ?>>parcelado (<?php echo $parcelas?>x)</option>
                <?php endif;?>
            </select>
