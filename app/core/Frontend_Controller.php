...
class Frontend_Controller extends MY_Controller
{
    ...
    private $JSfixo = array('jquery-1.10.2.min', 'bootstrap.min', 'hoverIntent', 'superfish.min', 'jquery.flexslider-min', 'page.all'); // assets précarregados
    private $CSSfixo = array('bootstrap', 'superfish', 'flexslider', 'base-layout', 'module-template'); // assets précarregados
    ...
    function __construct()
    {
        ...
        $this->load->library(array('site_utils', 'cms_conteudo', 'cms_posts', 'cms_adminbar', 'cms_metadados',
            'breadcrumb'));
    ...
    public function siteMenu(){
        return generate_menu(13, '.sf-menu');
    }
