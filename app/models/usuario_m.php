...
class Usuario_m extends CI_Model
{
	...
	{
		$user = $this->cms_usuario->get_session();
	...
	/**
	 * set special credentials on session
	 */
	public function setSpecialCredentials()
	{
		$this->phpsess->save('special_credentials', true);
	}

	public function removeSpecialCredentials()
	{
		$this->phpsess->save('special_credentials', false);
	}

	/**
	 * if user has special credentials to post a job
	 *
	 * @return bool
	 */
	public function hasSpecialCredentials()
	{
		if ($this->phpsess->get('special_credentials'))
		{
			return true;
		}
	...
	/**
	 * save url to redirect when logged in
	 *
	 * @param string $url
	 */
	public function setRedirectUrl($url = '')
	{
		if (strlen($url))
		{
			$this->phpsess->save('redirect_back', $url);
		}
		else
		{
			$this->phpsess->save('redirect_back', null);
		}
	}

	/**
	 * get the url to redirect, if not exists return 'usuario/index'
	 *
	 * @return string
	 */
	public function getRedirectUrl()
	{
		$url = $this->phpsess->get('redirect_back');
		if($url)
		{
			return $url;
		}
	...
	/**
	 * retrieve jobs for a user ID, or logged one
	 *
	 * @param null $userId
	 */
	public function getJobs($userId = null)
	{
