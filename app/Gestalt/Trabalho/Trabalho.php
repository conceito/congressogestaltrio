...
class Trabalho extends \CI_Model
{
	...
	{
		$fields = $this->mapFormFieldsToDb($post, 'create');
	 ...
	 * @return bool|int
	 */
	public function updateFromForm($jobId, $post = array())
	{
		$fields = $this->mapFormFieldsToDb($post, 'update');
		$metas  = $this->mapFormToMetadatas($post);
		...
		$this->db->update('cms_conteudo', $fields, array('id' => $jobId));
	 ...
	 * @return array
	 */
	private function mapFormFieldsToDb($form, $action = 'create')
	{
		$fields = array();
