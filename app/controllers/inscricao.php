...
class Inscricao extends Frontend_Controller
{
    ...
    public function login()
    {
        ...
        $this->title = 'Login';
        $this->corpo = $this->load->view('inscricao_login_form', '', true);
...
//        $this->setNewScript(array('jquery.tinymce'), 'libs');
    ...
    public function post_trabalho()
    {
        ...
        $this->form_validation->set_rules('curriculo_1', 'Minicurrículo (1)', 'trim|required|callback_html_max_length[500]');
